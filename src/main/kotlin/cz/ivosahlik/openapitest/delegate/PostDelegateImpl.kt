package cz.ivosahlik.openapitest.delegate

import cz.ivosahlik.openapitest.apis.PostDelegate
import cz.ivosahlik.openapitest.handler.NotFoundException
import cz.ivosahlik.openapitest.model.PostEntity
import cz.ivosahlik.openapitest.models.*
import cz.ivosahlik.openapitest.repository.PostRepository
...
class PostDelegateImpl(
    ...
    override fun updatePostById(postId: UUID,
                                updatePostRequestBody: UpdatePostRequestBody): ResponseEntity<Unit> {
        val postOptional = postRepository.findById(postId)
        val post = postOptional.orElseThrow { NotFoundException("Post does not exist ${postId}") }
